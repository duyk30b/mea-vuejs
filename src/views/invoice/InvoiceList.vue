...
import ModalInvoiceListSettingScreen from './components/ModalInvoiceListSettingScreen.vue'
    ...
    <div class="page-main-options">
      ...
      <div style="flex: 1; flex-basis: 250px;">
        ...
        <a-select v-model:value="invoiceStatus" allow-clear @change="handleSelectInvoiceStatus" class="w-full"
          ...
          <a-select-option :value="InvoiceStatus.Process"> Đang thực hiện </a-select-option>
          <a-select-option :value="InvoiceStatus.Finish"> Hoàn thành </a-select-option>
        ...
        <tbody>
          ...
          <tr v-for="(invoice, index) in invoiceList" :key="index"
            ...
            <td class="text-right">
              ...
              <div v-if="invoice.debt" class="text-xs">
