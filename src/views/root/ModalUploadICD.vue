...
import { IconCloudUpload, IconUpload } from '@/common/icon-google'
import { AlertStore } from '@/common/vue-alert/vue-alert.store'
import VueModal from '@/common/vue-modal/VueModal.vue'
import { FileICDApi } from '@/modules/file-excel/file-icd.api'
...
const handleUpload = async () => {
  ...
  try {
    await FileICDApi.uploadExcelICDList(fileSelect.value)
      ...
      <div class="px-4 mt-4">
        ...
        <div class="mt-2 flex justify-between text-xs" style="color: #666; font-style: italic">
          ...
          <div class="flex gap-1">
            ...
            <span style="font-weight: 700">25MB</span>
          </div>
        </div>
        <div class="mt-2 flex justify-between text-xs" style="color: #666"></div>
      </div>
      <div class="p-4 mt-2">
