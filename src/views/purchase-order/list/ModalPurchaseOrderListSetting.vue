...
const openModal = async () => {
  ...
  settingDisplay.value = JSON.parse(JSON.stringify(store.SCREEN_PURCHASE_ORDER_LIST))
}
...
const handleSave = async () => {
  ...
  try {
    ...
    await OrganizationService.saveSettings(SettingKey.SCREEN_PURCHASE_ORDER_LIST, settingData)
    AlertStore.addSuccess('Cập nhật cài đặt thành công')
    store.SCREEN_PURCHASE_ORDER_LIST = JSON.parse(settingData)
        ...
        <div class="table-wrapper">
          <table>
            ...
            <tbody>
              <tr>
                <td>
                  <InputCheckbox v-model:checked="settingDisplay.purchaseOrderItems">
                    Hiển thị sản phẩm
                  </InputCheckbox>
                </td>
              </tr>
