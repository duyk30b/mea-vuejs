...
const emit = defineEmits<{
  (e: 'addTicketProcedureList', value: TicketProcedure[]): void
  (e: 'addTicketRegimenList', value: TicketRegimen[]): void
}>()
...
const handleSave = async () => {
  ...
  emit('addTicketRegimenList', ticketRegimenListDraft.value)
...
<template>
  <div class="mt-4 flex flex-wrap">
    <div style="flex-basis: 300px; flex-grow: 1; position: relative; min-height: 300px">
      <div
        class="table-wrapper shadow-sm"
        style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; overflow-y: scroll"
      >
        <table>
          <thead>
            <tr>
              <th colspan="100">Chọn dịch vụ</th>
            </tr>
          </thead>
          <tbody>
            <tr>
