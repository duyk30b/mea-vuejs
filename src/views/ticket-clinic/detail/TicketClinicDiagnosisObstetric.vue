...
onMounted(async () => {
  console.log('🚀 ~ file: TicketClinicDiagnosisObstetric.vue:31 ~ onMounted')
})
...
<template>
  <div>
    ...
    <div v-if="ticketClinicRef.id" class="mt-4">
      <div>Hình ảnh</div>
      <ImageUploadMultiple
    ...
    <div class="mt-4 flex justify-between gap-4">
      <div></div>
      <VueButton
        v-if="ticketClinicRef.id && permissionIdMap[PermissionId.TICKET_CLINIC_UPDATE_DIAGNOSIS]"
        color="blue"
