<template>
  <div class="container">
    <div class="header">
      <p>Privacy Policy for MEA.VN - Phần mềm quản lý đơn hàng, phòng khám</p>
    </div>
    <hr />
    <div class="content">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            MEA.VN - Phần mềm quản lý đơn hàng, phòng khám.
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            usage trends, determining the effectiveness of our promotional campaigns and to evaluate
      ...
      <ul>
        ...
        <li>
          ...
          other subsidiaries, joint venture partners or other companies that We control or that are
    ...
    <hr />
    <div class="footer">MEA.VN©2020 - Phần mềm quản lý đơn hàng, phòng khám - Hotline: 0376.899.866</div>
  </div>
</template>
