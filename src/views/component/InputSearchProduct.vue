...
const setProductFromChild = async (productData: Product) => {
...
<template>
  ...
  <div class="flex gap-1 flex-wrap">
    ...
    <a
      v-if="showEditText && userPermission[PermissionId.PRODUCT_UPDATE] && product?.id"
  ...
  <div>
    <InputOptionsValue
      ...
      :required="required"
      @selectItem="({ data }) => setProductFromChild(data)"
