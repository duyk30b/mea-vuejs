...
import TicketClinicStatusTag from '../TicketTraditionalStatusTag.vue'
import ModalTicketClinicRegister from './ModalTicketTraditionalRegister.vue'
  ...
  try {
    ...
    const { data, meta } = await TicketApi.pagination({
      ...
      filter: {
        ...
        voucherType: VoucherType.Traditional,
      },
