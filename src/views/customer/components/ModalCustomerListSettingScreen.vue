    ...
    <div class="table-wrapper">
      <table class="screen-setting">
        ...
        <tbody>
          <tr>
            <td>
              <a-checkbox v-model:checked="settingDisplay.table.detail">Hiển thị nút xem chi tiết khách hàng (
                <FileSearchOutlined /> )
              </a-checkbox>
            </td>
          </tr>
          ...
          <tr>
            <td><a-checkbox v-model:checked="settingDisplay.table.gender">Hiển thị giới tính</a-checkbox></td>
          </tr>
          <tr>
            <td><a-checkbox v-model:checked="settingDisplay.table.birthday">Hiển thị ngày sinh</a-checkbox></td>
          </tr>
          <tr>
