...
const settingDisplay = ref<typeof store.SCREEN_CUSTOMER_UPSERT>(JSON.parse(JSON.stringify(store.SCREEN_CUSTOMER_UPSERT)))
      ...
      <div class="p-4">
        <table class="table-mobile">
          ...
          <tbody>
            ...
            <tr>
              <td><a-checkbox v-model:checked="settingDisplay.birthday">
                  Hiển thị ngày sinh
                </a-checkbox>
              </td>
            </tr>
