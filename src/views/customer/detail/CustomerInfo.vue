...
<template>
  <table class="w-full">
    <tr>
      ...
      <td class="px-2 font-medium">{{ customer!.fullName }}</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="px-2">{{ timeToText(customer.birthday, 'DD/MM/YYYY') }}</td>
    </tr>
    <tr>
      <td class="px-2 py-1 whitespace-nowrap">Giới tính</td>
      <td class="px-2" v-if="customer.gender === 1">Nam</td>
      <td class="px-2" v-if="customer.gender === 0">Nữ</td>
    </tr>
    <tr>
      <td class="px-2 py-1 whitespace-nowrap">Số căn cước</td>
      <td class="px-2">{{ customer.identityCard }}</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="px-2">{{ customer.relative }}</td>
    </tr>
    <tr>
      <td class="px-2 py-1 whitespace-nowrap">Công nợ</td>
      <td class="px-2 font-medium">{{ formatMoney(customer.debt) }}</td>
    </tr>
  </table>
</template>
