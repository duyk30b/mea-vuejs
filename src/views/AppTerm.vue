<template>
  <div class="container">
    <div class="header">
      <p>Terms and Conditions for MEA.VN - Phần mềm quản lý đơn hàng, phòng khám</p>
    </div>
    <hr />
    <div class="content">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Our&quot; in this Agreement) refers to MEA.VN - Phần mềm quản lý đơn hàng, phòng
            khám.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            ...
            refers to MEA.VN - Phần mềm quản lý đơn hàng, phòng khám, accessible from
            <a href="https://mea.vn" rel="external nofollow noopener" target="_blank">
              https://mea.vn
            </a>
          </p>
        </li>
      ...
      <ul>
        <li>
          <p>By email: meavn001@gmail.com</p>
        </li>
        <li>
          <p>By phone number: 0376899866</p>
        </li>
        <li>
          <p>By mail: CT2A, Thạch Bàn, Long Biên,Hà Nội</p>
        </li>
      </ul>
    </div>
    <hr />
    <div class="footer">
      MEA.VN©2020 - Phần mềm quản lý đơn hàng, phòng khám - Hotline: 0376.899.866
    </div>
  </div>
</template>
