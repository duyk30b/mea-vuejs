...
<template>
  ...
  <form @submit.prevent="(e: Event) => addProcedureItem()">
    <div class="mt-4">
      ...
      <div style="height: 40px">
        <InputOptions
          ...
          @selectItem="({ data }: any) => selectProcedure(data)"
      ...
      <table>
        ...
        <tbody>
          ...
          <tr v-for="(tpItem, index) in ticketProcedureList" :key="tpItem.procedureId">
            ...
            <td class="text-center">{{ DTimer.timeToText(tpItem.createdAt) }}</td>
            ...
            <td class="text-center">
              <a class="text-orange-500" @click="ticketProcedureList.splice(index, 1)">
                <IconEditSquare width="18" height="18" />
              </a>
            </td>
            <td class="text-center">
              <a
