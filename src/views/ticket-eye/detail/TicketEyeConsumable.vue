...
onMounted(async () => {
  console.log('🚀 ~ file: TicketEyeConsumable.vue:56  ~ onMounted')
  try {
    await Promise.all([productStore.refreshDB(), batchStore.refreshDB()])
  } catch (error: any) {
    console.log('🚀 ~ file: TicketEyeConsumable.vue:60 ~ onMounted ~ error:', error)
  }
})
...
const savePrescription = async () => {
  ...
  await TicketEyeApi.updateTicketProductConsumable({
    ...
    <div style="flex-grow: 1; flex-basis: 80%">
      ...
      <div style="height: 40px">
        <InputOptions
          ...
          :disabled="
            [TicketStatus.Completed, TicketStatus.Debt].includes(ticketEyeRef.ticketStatus)
          "
