...
import ModalAppointmentEyeSuccess from './ModalAppointmentEyeSuccess.vue'

const modalAppointmentEyeRegister = ref<InstanceType<typeof ModalAppointmentEyeRegister>>()
const modalAppointmentEyeSuccess = ref<InstanceType<typeof ModalAppointmentEyeSuccess>>()
...
const handleModalAppointmentEyeSuccessSuccess = async () => {
  await startFetchData()
}
...
<template>
  ...
  <ModalAppointmentEyeSuccess
    ref="modalAppointmentEyeSuccess"
    @success="handleModalAppointmentEyeSuccessSuccess" />
    ...
    <div class="flex items-center gap-4">
      ...
      <div>
        <VueButton
          ...
          icon="plus"
          color="blue"
          @click="modalAppointmentEyeRegister?.openModalForCreate(VoucherType.Eye)">
          Tạo lịch hẹn mới
        </VueButton>
      </div>
    </div>
          ...
          <tr v-for="(appointment, index) in appointmentList" :key="index">
              ...
              <div class="flex justify-between items-center">
                ...
                <div v-if="permissionIdMap[PermissionId.APPOINTMENT_UPDATE]">
                  <a
                    style="color: #eca52b"
                    class="text-xl"
                    @click="modalAppointmentEyeRegister?.openModalForUpdate(appointment)">
                    <IconEditSquare />
                  </a>
                </div>
              </div>
            ...
            <td class="text-center" style="width: 200px">
              <div
                ...
                <VueButton size="small" @click="modalAppointmentEyeSuccess?.openModal(appointment)">
                  Đăng ký khám
                </VueButton>
              </div>
              <div v-if="[AppointmentStatus.Completed].includes(appointment.appointmentStatus)">
                <a @click="openBlankTicketEyeDetail(appointment.toTicketId)">
