...
const settingDisplay = ref<typeof store.SCREEN_RECEIPT_DETAIL>(JSON.parse(JSON.stringify(store.SCREEN_RECEIPT_DETAIL)))
...
const handleSave = async () => {
  ...
  try {
    ...
    await OrganizationService.saveSettings(OrganizationSettingsType.SCREEN_RECEIPT_DETAIL, settingData)
