      ...
      <table class="table">
        <thead>
          <tr>
            ...
            <th v-if="organizationStore.SCREEN_PRODUCT_LIST.group">Nhóm</th>
            <th v-if="organizationStore.SCREEN_PRODUCT_LIST.unit">Đ.Vị</th>
            <th v-if="organizationStore.SCREEN_PRODUCT_LIST.batch">Lô</th>
            ...
            <th v-if="organizationStore.SCREEN_PRODUCT_LIST.expiryDate" class="cursor-pointer"
            ...
            <th v-if="organizationStore.SCREEN_PRODUCT_LIST.costPrice">G.Nhập</th>
            <th v-if="organizationStore.SCREEN_PRODUCT_LIST.wholesalePrice">G.Sỉ</th>
            <th v-if="organizationStore.SCREEN_PRODUCT_LIST.retailPrice">G.Lẻ</th>
            <th v-if="organizationStore.SCREEN_PRODUCT_LIST.isActive">Trạng thái</th>
            ...
            <template v-for="(product, index) in productList" :key="index">
              <tr>
                ...
                <td :rowspan="product.productBatches.length || 1">
                  <div>
                    {{ product.brandName }}
                    <a v-if="organizationStore.SCREEN_PRODUCT_LIST.detail" class="ml-1"
                ...
                <td v-if="organizationStore.SCREEN_PRODUCT_LIST.group" :rowspan="product.productBatches.length || 1"
                  class="text-center">
                  {{ organizationStore.PRODUCT_GROUP[product.group!] }}
                </td>
                <td v-if="organizationStore.SCREEN_PRODUCT_LIST.unit" :rowspan="product.productBatches.length || 1"
                  class="text-center">
                  {{ product.unit[0].name }}
                </td>
                ...
                <td v-if="organizationStore.SCREEN_PRODUCT_LIST.isActive" :rowspan="product.productBatches.length || 1"
                  class="text-center">
                ...
                <td v-if="organizationStore.SCREEN_PRODUCT_LIST.action" :rowspan="product.productBatches.length || 1"
                  class="text-center">
              ...
              <tr v-for="(avail, i) in product.productBatches.slice(1)" :key="i">
                <td v-if="organizationStore.SCREEN_PRODUCT_LIST.batch" class="text-center">{{ avail.batch }}</td>
