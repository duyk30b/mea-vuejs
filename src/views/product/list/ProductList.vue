    ...
    <div class="page-main-options">
      ...
      <div style="flex: 1; flex-basis: 250px">
        ...
        >
          ...
          <a-select-option
            v-for="(text, value) in organizationStore.PRODUCT_GROUP"
            :key="value"
            :value="value"
          >
            {{ text }}
    ...
    <div v-if="isMobile" class="page-main-list">
      ...
      <div v-else>
        ...
        >
          ...
          <div
            v-if="product.productBatches.length > 0 && organizationStore.SCREEN_PRODUCT_LIST.batch"
          >
            ...
            <template v-for="(product, index) in productList" :key="index">
              <tr>
                ...
                <td :rowspan="product.productBatches.length || 1">
                  ...
                  <div
                    v-if="organizationStore.SCREEN_PRODUCT_LIST.substance"
