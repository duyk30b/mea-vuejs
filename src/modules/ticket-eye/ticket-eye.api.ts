...
export class TicketEyeApi {
  static async register(body: {
    ...
    const response = await AxiosInstance.post('/ticket-eye/register', body)
  ...
  static async destroyDraftSchedule(ticketId: number) {
    const response = await AxiosInstance.delete(`/ticket-eye/${ticketId}/destroy-draft-schedule`)
    const { data } = response.data as BaseResponse
  }

  static async startCheckup(params: { ticketId: number }) {
    const response = await AxiosInstance.post(`/ticket-eye/${params.ticketId}/start-checkup`)
  ...
  static async updateTicketProcedureList(body: {
    ...
    const response = await AxiosInstance.post(
      `/ticket-eye/${ticketId}/update-ticket-procedure-list`,
      {
  ...
  static async updateTicketProductConsumable(body: {
    ...
    const response = await AxiosInstance.post(
      `/ticket-eye/${ticketId}/update-ticket-product-consumable`,
      {
  ...
  static async updateTicketProductPrescription(body: {
    ...
    const response = await AxiosInstance.post(
      `/ticket-eye/${ticketId}/update-ticket-product-prescription`,
      {
  ...
  static async updateItemsMoney(body: {
    ...
    const response = await AxiosInstance.post(`/ticket-eye/${ticketId}/update-items-money`, {
  ...
  static async sendProduct(body: { ticketId: number }) {
    const { ticketId } = body
    const response = await AxiosInstance.post(`/ticket-eye/${ticketId}/send-product`)
    const { data } = response.data as BaseResponse
  }
  ...
  static async returnProduct(body: {
    ...
    const response = await AxiosInstance.post(`/ticket-eye/${ticketId}/return-product`, {
      returnList,
    })
    const { data } = response.data as BaseResponse
    return data
  ...
  static async prepayment(ticketId: number, money: number) {
    const response = await AxiosInstance.post(`/ticket-eye/${ticketId}/prepayment`, { money })
    const { data } = response.data as BaseResponse
  }

  static async refundOverpaid(ticketId: number, money: number) {
    const response = await AxiosInstance.post(`/ticket-eye/${ticketId}/refund-overpaid`, {
      money,
    })
    const { data } = response.data as BaseResponse
  }
  ...
  static async payDebt(ticketId: number, money: number) {
    const response = await AxiosInstance.post(`/ticket-eye/${ticketId}/pay-debt`, {
      money,
    })
    const { data } = response.data as BaseResponse
  }
  ...
  static async close(ticketId: number) {
    const response = await AxiosInstance.post(`/ticket-eye/${ticketId}/close`)
    const { data } = response.data as BaseResponse
  }

  static async reopen(ticketId: number) {
    const response = await AxiosInstance.post(`/ticket-eye/${ticketId}/reopen`)
    const { data } = response.data as BaseResponse
  }
}
