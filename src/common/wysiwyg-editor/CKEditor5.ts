...
class CKEditor5Collapse extends ClassicEditor {}

class CKEditor5Normal extends ClassicEditor {}

CKEditor5Collapse.builtinPlugins = pluginList
CKEditor5Normal.builtinPlugins = pluginList

CKEditor5Collapse.defaultConfig = {
  toolbar: {
    items: [
      'undo',
      'redo',
...
export { CKEditor5Collapse, CKEditor5Normal }
